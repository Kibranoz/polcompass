...
class AnswerSelection extends Component{
    constructor(props) {
        super(props);
        this.infos = {lastAffected:"economic",lastDirection:0,lastIntensity:0, lastAnswer:1, canGoBack:false};
      }
        ...
        return(
          ...
          <div className = "questionArea">
            <Fragment>
                ...
                <AnswerButton answer="Neutral" clickHandler={this.chooseAppropriateClickHandler(0,0)} updater={this.chooseUpdateInfos(0,0)} color = "#EEE573"></AnswerButton>
                ...
                <AnswerButton answer="Completely Disagree"  color = "#EE7373" clickHandler={this.chooseAppropriateClickHandler(-1,2)}updater={this.chooseUpdateInfos(-1,2)}></AnswerButton>
